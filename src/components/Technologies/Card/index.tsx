...
export default function TechnologyCard({name}: TechnologyCardProps) {
  ...
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 w-fit">
      <div className={`flex flex-col ${color} p-3 items-center rounded-lg h-32 w-44 justify-center gap-3`}>
